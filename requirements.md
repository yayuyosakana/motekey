...
- **対象外:** 自分から話題を切り出す（自分発信の）メッセージ生成機能。ユーザーが任意に添付する写真・動画等のマルチモーダル入力による文脈把握（※Broadcast Extensionの最新1フレーム解析は対象範囲）。スタンプへの対応。
...
| 日付       | 版  | 変更内容                                             | 担当者 |
| ---------- | --- | ---------------------------------------------------- | ------ |
| 2026-03-21 | 1.7 | スコープ定義の対象外文言を明確化し、Broadcast最新1フレーム解析との整合を明記 |        |
