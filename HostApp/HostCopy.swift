...
enum HostCopy {
    ...
    enum S004 {
        ...
        static let recordingStep1 = "1) 下の「画面収録を開始」をタップ"
        static let recordingStep2 = "2) 表示されたシートで「モテキー」を選択"
        static let recordingStep3 = "3) ブロードキャストを開始 をタップ"
        static let recordingStep4 = "4) LINEに戻る"
        static let recordingStep5 = "5) ステータスが「開始済み」になれば完了"
        static let startRecordingButton = "画面収録を開始"
        static let recordingStatusActive = "画面収録: 開始済み"
        static let recordingStatusInactive = "画面収録: 未開始"
        static let recordingAcknowledgement = "画面収録の開始を手動で確認した"
