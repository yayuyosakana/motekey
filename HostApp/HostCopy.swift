...
enum HostCopy {
    ...
    enum S003 {
        ...
        static let birthdayAndCautionPrompt = "誕生日と気をつけること"
    ...
    enum S004 {
        ...
        static let completeSubheadline = "次にメッセージアプリでモテキーへ切り替える手順を確認します"
        static let viewTutorial = "使い方を見る"
        static let later = "あとで"
        static let tutorialStep1 = "1. メッセージアプリを開く"
        static let tutorialStep2 = "2. 入力欄をタップしてキーボードを表示"
